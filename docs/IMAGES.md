...
|---|---|---|
| What | The 43 exercise PNGs + 8 category heroes | A photo someone attaches to a custom exercise |
...
Adding an image means committing it and redeploying. That is exactly right for 43 curated
