...
The 42 PNGs total roughly **33 MB**. They used to be compiled into the Android APK, so every
...
cdn/
  public/
    images/<category>/<file>.png    42 exercise photos
...
`HEAD` them; all 42 must return `200`.
